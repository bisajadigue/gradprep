...
export default function LandingPage() {
  ...
  return (
    <>
      ...
      <main className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden">
        <div className="container flex flex-col items-center justify-center px-[10vw]">
          ...
          <h1>
            ...
            <span className=" italic text-primary">20 menit</span>.
          </h1>
        </div>
      ...
      {/* Section 2 */}
      <div className="relative flex h-fit min-h-[90vh] flex-col items-center justify-center bg-primary text-center text-white md:text-start">
        <div className="container flex flex-col md:flex-row">
          ...
          <div className="flex flex-col justify-center md:max-w-[60%]">
            <h2 className=" flex-wrap">
              Apakah kamu siap menghadapi tantangan masa depan?
            </h2>
            <p>
      ...
      {/* Section 3 */}
      <div className="relative flex min-h-[90vh] flex-col items-center justify-center bg-white pb-20">
      ...
      <div className="relative flex h-[90vh] flex-col items-center justify-start bg-primary text-white">
        {/* popup */}
        <div className="container relative -top-[13vh] flex h-[26vh] flex-col items-center justify-center gap-y-3 rounded-[15px] bg-white p-20 text-black shadow-lg shadow-gray-700">
          <h2>Mitra Kami</h2>
          <div className="grid w-full grid-cols-4 place-content-between place-items-center md:grid-cols-8">
            {LOGOS.map((logo, i) => (
              <Image
                key={i}
        ...
        <h2 className="container mb-4 text-center">Kata Mereka</h2>
        <div className="container flex flex-row justify-center gap-x-4 sm:gap-x-6 md:gap-x-12">
          ...
          <div className="flex w-[70vw] flex-col gap-4 text-center md:w-[30vw]">
            ...
            <p>
              GradPrep sangat membantuku dalam pencarian dan persiapan untuk
              program S2, karena informasinya lengkap dan mock test nya berguna.
            </p>
          </div>
          <button className="transition-all active:scale-[0.85]">
